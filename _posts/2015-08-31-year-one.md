...
It's certainly not at all what I expected to have in a year's time, but let's see how we did in comparison to our goals set out in the <a href="{{ site.url }}{{ site.baseurl }}{% post_url 2014-08-31-leaping-out-on-a-jekyll-tether %}" target="_blank">first post</a>:
